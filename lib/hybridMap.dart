...
class uccmaphybrid extends StatefulWidget {
  @override
  _uccmaphybridPageState createState() => new _uccmaphybridPageState();
}
Completer<GoogleMapController> _controller = Completer();

class _uccmaphybridPageState extends State<uccmaphybrid> {
  @override
  void initState() {
    super.initState();
  }
          ...
          children: <Widget>[
            ...
            Padding(
              ...
              child: _boxes(
                  ...
                  40.738380, -73.988426, "CELT", "24/7 Service"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  ...
                  40.761421, -73.981667, "UCC Administration", "8:00 AM - 5:00 PM"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
            ...
            Padding(
              ...
              child: _boxes(
                  ...
                  40.732128, -73.999619, "NEC", "6:00 AM - 8:30 PM"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
              child: _boxes(
                  "https://lh5.googleusercontent.com/p/AF1QipNkFkCOAlAEOSA207jiYeopi2IAA8AOAlyEZwVE=w241-h160-k-no",
                  40.732128, -73.999619, "Institute of Education", "8:00 AM - 5:00 PM"),
            ),
            SizedBox(width: 10.0),
            Padding(
              padding: const EdgeInsets.all(8.0),
            ...
            Padding(
              ...
              child: _boxes(
                  ...
                  5.11742, -1.29262, "UCC Hospital", "24/7 Service"),
            ),
          ],
        ),
      ),
